...
void myKeyboard(int key, int x, int y)
{
	...
	if (key == GLUT_KEY_F5) {
		...
		strcpy(caminhoArquivo,"Cameras/");
		strcpy(caminhoArquivoObj, "Objetos/");
		printf("digite o nome do arquivo desejado da Camera \n");
		scanf("%s", &NomeCamera);
		printf("digite o nome do arquivo desejado do Objeto ");
		scanf("%s", &NomeObjeto);
